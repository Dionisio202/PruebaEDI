...
class EvaluationCreateSerializer(serializers.Serializer):
    ...
    document_id = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    ...
    def create(self, validated_data):
        ...
        if use_corrected_age:
            age_in_months = patient.get_corrected_age_months()
        else:
            age_in_months = patient.get_age_months()
        ...
        evaluation = Evaluation.objects.create(
            ...
            notes=notes,
            # Valores por defecto que se actualizarán
